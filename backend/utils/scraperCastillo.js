        ...
        try {
            ...
            */}
            ...
            if (urlElement) {
                ...
                // primero declaro el objetivo vacio
                const product = {};

                // url del producto
                product.product_url = `https://www.castillo.com.ar${href}`

                // imagen del producto
                await page.waitForSelector('.vtex-store-components-3-x-productImageTag.vtex-store-components-3-x-productImageTag--main');
                const producto_scr = await page.$('.vtex-store-components-3-x-productImageTag.vtex-store-components-3-x-productImageTag--main')
                ...
                const shippingText = await page.locator('[class="castillo-pdp-components-1-x-shipping-estimate-results"]').first().innerText();
